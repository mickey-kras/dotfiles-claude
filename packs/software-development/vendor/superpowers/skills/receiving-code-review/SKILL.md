...
GOOD: RIGHT: "I understand items 1,2,3,6. Need clarification on 4 and 5 before proceeding."
```
...
Default rule: External feedback should be checked carefully, not followed blindly.
...
If the feature is unused or unwanted, prefer YAGNI over implementing it "properly."
